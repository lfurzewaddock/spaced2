  ...
  return (
    <article
      className={cn(
        ...
        'sm:dark:bg-muted/20 sm:border dark:border-none dark:prose-p:text-foreground dark:prose-strong:text-foreground dark:prose-headings:text-foreground dark:prose-li:text-foreground dark:prose-a:text-foreground/60 dark:prose-table:text-foreground/60',
